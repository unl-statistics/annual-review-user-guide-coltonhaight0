...
To look at how spline can be used on data we need to plot it in the coding language R. If you are unfamiliar with R we will start with a quick overview of R [Bates, -@bates_tutorial_2020], where to download it, and how to get started. If you already have knowledge of R then you can skip this next section.
...
If in need of more help, go to these resources below.
...
5.  [Download R-4.5.2 for Windows](https://cran.r-project.org/bin/windows/base/)
6.  [R for macOS](https://cran.r-project.org/bin/macosx/)
7.  [RStudio Desktop](https://posit.co/download/rstudio-desktop/)
8.  [Housing Data](https://www.kaggle.com/datasets/yasserh/housing-prices-dataset)
